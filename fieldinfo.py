...
fieldinfo = {
  ...
  't2'           :{ 'levels' : range(25,105,2), 'cmap': readNCLcm('nice_gfdl')[53:193], 'fname': ['T2'] },
  ...
  'hgt900'       :{ 'levels' : [550,580,610,640,670,700,730,760,790,820,850,880,910,940,970,1000,1030], 'cmap': readNCLcm('nice_gfdl')[3:193], 'fname': ['GHT_PL'], 'filename':'diag' },
  ...
  'speed900'     :{ 'levels' : [6,10,14,18,22,26,30,34,38,42,46,50,54,58,62,66,70,74], 'cmap': readNCLcm('wind_17lev'), 'fname': ['S_PL'], 'filename':'diag'},
